...
$serviceProjects = @(
    "Architect4Hire.AspireHire.TokenServiceDomainLayer",
    "Architect4Hire.AspireHire.UserServiceDomainLayer",
    "Architect4Hire.AspireHire.ContractServiceDomainLayer",
    "Architect4Hire.AspireHire.JobServiceDomainLayer",
    "Architect4Hire.AspireHire.MessageServiceDomainLayer",
    "Architect4Hire.AspireHire.PaymentServiceDomainLayer",
    "Architect4Hire.AspireHire.ProfileServiceDomainLayer",
    "Architect4Hire.AspireHire.ProposalServiceDomainLayer",
    "Architect4Hire.AspireHire.UtilityServiceDomainLayer"
)
...
$folders = @(
    ...
    "Managers/Extensions",
    "Managers/Models",
    "Managers/Models/ViewModels",
    "Managers/Models/ServiceModels",
    "Business",
