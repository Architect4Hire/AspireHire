...
- Create Angular project with ng: `ng new architect4hire.aspirehire.frontend.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`architect4hire.aspirehire.frontend.client.esproj`).
